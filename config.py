...
class ScriptArguments:
    ...
    learning_rate: Optional[float] = field(default=1e-4, metadata={"help": "the learning rate, default 5e-5, fp uses 1 / sqrt(d)"})    # vicuna and a
    ...
    peft_lora_alpha: Optional[int] = field(default=512, metadata={"help": "the alpha parameter of the LoRA adapters"}) # vanilla is 16
