...
from loftq_config import get_config, save_config, get_model_config, get_training_args
...
# there are all Nones in quantization_config if using loftq
...
for round in tqdm(range(fed_args.num_rounds)):
    ...
    global_dict, global_auxiliary = global_aggregate(
        ...
        opt_proxy_dict=opt_proxy_dict, auxiliary_info=(global_auxiliary, auxiliary_delta_dict), overall_drop_rate=0
    )
